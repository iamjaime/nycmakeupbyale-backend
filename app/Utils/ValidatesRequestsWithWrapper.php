...
trait ValidatesRequestsWithWrapper
{
    /**
    ...
    public function validateWith($validator, Request $request = null)
    {
        ...
        if (is_array($validator)) {
            $validator = $this->getValidationFactory()->make($request->input('data'), $validator);
        }
    ...
    {
        $validator = $this->getValidationFactory()->make($request->input('data'), $rules, $messages, $customAttributes);
    ...
    /**
     * Validate the given request with the given rules and no wrapper.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  array  $rules
     * @param  array  $messages
     ...
     * @return void
     */
    public function validateNoWrapper(Request $request, array $rules, array $messages = [], array $customAttributes = [])
    {
